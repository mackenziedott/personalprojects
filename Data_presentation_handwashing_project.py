...
clinic_1 = yearly.query('clinic.str.contains("clinic 1")', engine = 'python')
clinic_2 = yearly.query('clinic.str.contains("clinic 2")', engine = 'python')
...
confidence_interval = boot_mean_diff.sample()
confidence_interval
